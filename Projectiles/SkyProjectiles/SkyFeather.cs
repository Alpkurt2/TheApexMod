    ...
    public class SkyFeather : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                int num165 = Dust.NewDust(new Vector2(x2, y2), 1, 1, DustID.AncientLight);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.AncientLight, 0f, 0f, 100, default(Color), 1.5f);
