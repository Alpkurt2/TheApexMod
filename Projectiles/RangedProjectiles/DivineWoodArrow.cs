...
{
    public class DivineWoodArrow : ModProjectile
    {
        public override void SetDefaults()
        {
            projectile.Name = "DivineWoodArrow";
            projectile.width = 18;
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.PinkFlame, 0f, 0f, 100, default(Color), 3f);
                Main.dust[dust].noGravity = true;
                Main.dust[dust].velocity *= 7f;
                dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.PinkFlame, 0f, 0f, 100, default(Color), 1f);
