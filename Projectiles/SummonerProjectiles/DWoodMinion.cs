...
{
	public class DWoodMinion : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Divinewood Minion");
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(ModContent.BuffType<DivineWoodMinionBuff>());
			}
			if (player.HasBuff(ModContent.BuffType<DivineWoodMinionBuff>()))
			{
