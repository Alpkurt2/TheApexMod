...
{
	public class EWoodMinion : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (player.dead || !player.active || player.ownedProjectileCounts[ModContent.ProjectileType<EWoodMinion>()] < 0)
			{
				player.ClearBuff(ModContent.BuffType<EWoodMinionBuff>());
			}
			if (player.HasBuff(ModContent.BuffType<EWoodMinionBuff>()))
			{
