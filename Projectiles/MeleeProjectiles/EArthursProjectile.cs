...
{
    public class EArthursProjectile : ModProjectile
    {
        ...
        {
            projectile.Name = "EArthursProjectile";
            projectile.width = 18;
        ...
        public override void AI()
        {
            ...
            {
                int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.AmberBolt);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.AmberBolt, 0f, 0f, 100, default(Color), 1.5f);
                int dust2 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 135, 0f, 0f, 100, default(Color), 1.5f);
                Main.dust[dust].noGravity = true;
