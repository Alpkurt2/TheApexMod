...
{
    public class ApexSwordRain : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            float x = projectile.position.X - 1000;
            float y = projectile.position.Y;
            float velY = 0;
            float velX = 50;
            Projectile.NewProjectile(new Vector2(x, y), new Vector2(velX, velY), mod.ProjectileType("ApexSwordTyphoon"), projectile.damage, projectile.knockBack, projectile.owner);
            float x2 = projectile.position.X + 1000;
            float velX2 = -50;
            Projectile.NewProjectile(new Vector2(x2, y), new Vector2(velX2, velY), mod.ProjectileType("ApexSwordTyphoon"), projectile.damage, projectile.knockBack, projectile.owner);
        }
