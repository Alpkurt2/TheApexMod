...
{
    public class ICaneProj : ModProjectile
    {
        public override void SetDefaults()
        {
            projectile.CloneDefaults(ProjectileID.TerraBeam);
            projectile.Name = "IcyCane";
        ...
        public override void AI()
        {
            ...
            num313 = Dust.NewDust(new Vector2(projectile.position.X - projectile.velocity.X * 4f + 2f, projectile.position.Y + 2f - projectile.velocity.Y * 4f), 8, 8, 226, projectile.oldVelocity.X, projectile.oldVelocity.Y, 100, default(Color), 1.25f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                dust = Dust.NewDust(projectile.Center, projectile.width,
                    projectile.height, 226, 0f, 0f, 100, default(Color), 1f);
                Main.dust[dust].velocity *= 1.5f;
                Main.dust[dust].noGravity = true;
