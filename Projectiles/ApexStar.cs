...
{
    public class ApexStar : ModProjectile
    {
        public override void SetDefaults()
        {
            projectile.Name = "ApexStar";
            projectile.width = 32;
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            speed.Normalize();
            speed *= 20f;
            Projectile.NewProjectile(spawn, speed * 2, ModContent.ProjectileType<ApexStar2>(), damage*3, 1f, Main.myPlayer);
        }
