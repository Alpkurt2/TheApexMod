...
{
    public class Stazzler : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Stazzler");
        }
        public override void ModifyTooltips(List<TooltipLine> list)
        {
            foreach (TooltipLine tooltipLine in list)
            {
                ...
                {
                    tooltipLine.overrideColor = new Color(150, 150, 150);
                }
            }
        }
        public override void SetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shoot = mod.ProjectileType("StazzlerProjectile");
            item.shootSpeed = 30;
        }
